...
% \cite{Nelson1982} models the role of knowledge in R\&D.
...
% \cite{JaffeTrajtenbergHenderson1993} finds that citations to domestic patents are more likely to be domestic

% \cite{RajanZingales2001} study how the entrepreneur's response to this problem determines the organization's internal structure, growth, and its eventual size

% \cite{KoganPapanikolaouSeruStoffman2017} proposes a new measure of each innovation's economic importance. 

% \cite{CrémerGaricanoPrat2007}
