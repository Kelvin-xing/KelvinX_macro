...
kappa   = 0;                % fixed cost of joining modern sector
theta   = 0.999; 
rhom    = 0.95;             % probability to keep z of modern guy
rhot    = rhom;             % probability to keep z of trad. guys
...
for i = 1 : 50                               % do a couple to give better starting values for newton
...
for i = 1 : 20*0       %newton iterations
