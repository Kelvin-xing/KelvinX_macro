...
L  = (alpha/W)^(1-alpha).*((1-alpha)./(rr+delta)).^(-(1-alpha)).*exp(e).^(1-1/eta).*Y.^(1/eta);
K  = (alpha/W)^(-alpha).*((1-alpha)./(rr+delta)).^alpha.*exp(e).^(1-1/eta).*Y.^(1/eta);

Lf = (alpha/W)^(1-alpha).*((1-alpha)./(r+delta)).^(-(1-alpha)).*exp(e).^(1-1/eta).*Yf.^(1/eta);
Kf = (alpha/W)^(-alpha).*((1-alpha)./(r+delta)).^alpha.*exp(e).^(1-1/eta).*Yf.^(1/eta);
