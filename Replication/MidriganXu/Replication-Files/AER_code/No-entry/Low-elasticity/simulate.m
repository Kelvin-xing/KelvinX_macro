...
L = eta^(1/(1-eta))*(W/alpha)^(-gamma)*(alpha^gamma*W^(1-gamma) + (1-alpha)^gamma*(rr+delta).^(1-gamma)).^(1/(1-gamma)*(gamma-1/(1-eta))).*exp(e);
K = eta^(1/(1-eta))*((rr+delta)/(1-alpha)).^(-gamma).*(alpha^gamma*W^(1-gamma) + (1-alpha)^gamma*(rr+delta).^(1-gamma)).^(1/(1-gamma)*(gamma-1/(1-eta))).*exp(e);
Y = eta^(eta/(1-eta))*(alpha^gamma*W^(1-gamma) + (1-alpha)^gamma*(rr+delta).^(1-gamma)).^(1/(1-gamma)*eta/(eta-1)).*exp(e);  
...
Lf = eta^(1/(1-eta))*(W/alpha)^(-gamma)*(alpha^gamma*W^(1-gamma) + (1-alpha)^gamma*(r+delta).^(1-gamma)).^(1/(1-gamma)*(gamma-1/(1-eta))).*exp(e);
Kf = eta^(1/(1-eta))*((r+delta)/(1-alpha)).^(-gamma).*(alpha^gamma*W^(1-gamma) + (1-alpha)^gamma*(r+delta).^(1-gamma)).^(1/(1-gamma)*(gamma-1/(1-eta))).*exp(e);
Yf = eta^(eta/(1-eta))*(alpha^gamma*W^(1-gamma) + (1-alpha)^gamma*(r+delta).^(1-gamma)).^(1/(1-gamma)*eta/(eta-1)).*exp(e);  
...
TFP      = mean(Y(:))./(alpha*mean(L(:)).^(1-1/gamma) + (1-alpha)*mean(K(:)).^(1-1/gamma))^(gamma/(gamma-1)*eta);
TFPbest  = mean(Yf(:))./(alpha*mean(Lf(:)).^(1-1/gamma) + (1-alpha)*mean(Kf(:)).^(1-1/gamma))^(gamma/(gamma-1)*eta);
