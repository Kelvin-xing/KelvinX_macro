...
amin =  exp(-7)+.001;                      % tricky right at 0, so move a bit to be able to solve it        
...
for i = 1 : 600                               % do a couple to give better starting values for newton
...
for i = 1 : 50*0       %newton iterations
