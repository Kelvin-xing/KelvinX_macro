...
A = nodeunif(150000, -theta*(kappau) + eps^(1/4), 10);
...
sa = sign(1/(1-theta)*A + theta/(1-theta)*(kappau) - K);   % this must be < 0
...
sb = sign(1/(1-theta)*A + theta/(1-theta)*(kappau) - K);   % this must be > 0
...
sx = sign(1/(1-theta)*A + theta/(1-theta)*(kappau) - K);   % this must be > 0
