...
nuk       = 0;                  % fraction of kappa that is pledgeable
...
% case 2: fixed cost, original theta and xai
...
% theta = 0.25;       % raise unproductive lower bound 0.01
% W     = 0.9725;
% r     = 0.0192;
...
% % old r: ADJUST LOWER BOUNDS ON TRADITIONAL ASSETS BY 0.01 up
% theta = 0.05;
% xai   = 0;
% W     = 0.899;
% r     = 0.046754247588991;
