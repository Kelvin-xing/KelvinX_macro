...
pis = M_.params( 11 );
M_.params( 12 ) = ((M_.params(4)-1)*(1+M_.params(7))+M_.params(11)*M_.params(5)*(M_.params(11)-1)*(1-M_.params(3))/(1+M_.params(5)/2*(M_.params(11)-1)^2))/(M_.params(4)*M_.params(2));
hs = M_.params( 12 );
