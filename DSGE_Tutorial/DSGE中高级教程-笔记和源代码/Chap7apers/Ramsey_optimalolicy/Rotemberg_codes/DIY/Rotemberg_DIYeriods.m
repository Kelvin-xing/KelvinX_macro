...
options_ = [];
M_.fname = 'Rotemberg_DIY_periods';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('Rotemberg_DIY_periods.log');
M_.exo_names = 'eps_A';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('Rotemberg_DIY_periods_static');
erase_compiled_function('Rotemberg_DIY_periods_dynamic');
...
save('Rotemberg_DIY_periods_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('Rotemberg_DIY_periods_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('Rotemberg_DIY_periods_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('Rotemberg_DIY_periods_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('Rotemberg_DIY_periods_results.mat', 'estimation_info', '-append');
end
