...
M_.endo_names = char(M_.endo_names, 'AUX_EXO_LEAD_247');
M_.endo_names_tex = char(M_.endo_names_tex, 'AUX\_EXO\_LEAD\_247');
M_.endo_names = char(M_.endo_names, 'AUX_EXO_LEAD_251');
M_.endo_names_tex = char(M_.endo_names_tex, 'AUX\_EXO\_LEAD\_251');
M_.endo_names = char(M_.endo_names, 'AUX_EXO_LEAD_255');
M_.endo_names_tex = char(M_.endo_names_tex, 'AUX\_EXO\_LEAD\_255');
M_.endo_names = char(M_.endo_names, 'AUX_EXO_LEAD_199');
M_.endo_names_tex = char(M_.endo_names_tex, 'AUX\_EXO\_LEAD\_199');
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('ZLB_four_dynamic');
...
M_.params = repmat(NaN,33, 1);
M_.NNZDerivatives = zeros(3, 1);
M_.NNZDerivatives(1) = 93;
...
vps = M_.params( 28 );
M_.params( 24 ) = (M_.params(6)-1)*M_.params(21)*(1-M_.params(21)^M_.params(6)*M_.params(2)*M_.params(5))/(1-M_.params(2)*M_.params(5)*M_.params(21)^(M_.params(6)-1))/M_.params(29)/M_.params(6);
mcs = M_.params( 24 );
...
save('ZLB_four_results.mat', 'oo_', 'M_', 'options_');
diary off
