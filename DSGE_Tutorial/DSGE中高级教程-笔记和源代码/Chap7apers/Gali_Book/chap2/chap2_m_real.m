...
options_ = [];
M_.fname = 'chap2_m_real';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('chap2_m_real.log');
M_.exo_names = 'eps_A';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('chap2_m_real_static');
erase_compiled_function('chap2_m_real_dynamic');
...
Ys = M_.params( 15 );
M_.params( 16 ) = M_.params(15)/M_.params(13)^M_.params(7);
ms = M_.params( 16 );
%
% SHOCKS instructions
%
...
save('chap2_m_real_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('chap2_m_real_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('chap2_m_real_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('chap2_m_real_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('chap2_m_real_results.mat', 'estimation_info', '-append');
end
