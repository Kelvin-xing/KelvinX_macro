...
options_ = [];
M_.fname = 'chap2_m_growth';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('chap2_m_growth.log');
M_.exo_names = 'eps_A';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('chap2_m_growth_static');
erase_compiled_function('chap2_m_growth_dynamic');
...
save('chap2_m_growth_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('chap2_m_growth_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('chap2_m_growth_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('chap2_m_growth_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('chap2_m_growth_results.mat', 'estimation_info', '-append');
end
