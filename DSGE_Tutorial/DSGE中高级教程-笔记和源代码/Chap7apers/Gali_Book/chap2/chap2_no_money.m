...
options_ = [];
M_.fname = 'chap2_no_money';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('chap2_no_money.log');
M_.exo_names = 'eps_A';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('chap2_no_money_static');
erase_compiled_function('chap2_no_money_dynamic');
...
M_.params( 9 ) = 1;
pis = M_.params( 9 );
M_.params( 13 ) = M_.params(12);
rs = M_.params( 13 );
M_.params( 11 ) = (1-M_.params(1))^(1/(M_.params(4)+M_.params(1)*(1-M_.params(4))+M_.params(5)));
Ns = M_.params( 11 );
M_.params( 7 ) = M_.params(10)*M_.params(11)^(1-M_.params(1));
Cs = M_.params( 7 );
M_.params( 8 ) = (1-M_.params(1))*M_.params(10)*M_.params(11)^(-M_.params(1));
ws = M_.params( 8 );
...
oo_.steady_state( 7 ) = log(M_.params(13));
oo_.steady_state( 5 ) = log(M_.params(11));
oo_.steady_state( 1 ) = log(M_.params(7));
oo_.steady_state( 2 ) = log(M_.params(8));
oo_.steady_state( 8 ) = log(M_.params(14));
if M_.exo_nbr > 0;
...
save('chap2_no_money_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('chap2_no_money_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('chap2_no_money_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('chap2_no_money_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('chap2_no_money_results.mat', 'estimation_info', '-append');
end
