 ...
 * 
 * This file is written by Xiangyang Li@Guangzhou, 2016-3-18
...
;		
varexo  eps_a eps_y_star eps_a_star eps_v;
...
rho_v  = 0.9;      //not present in textbook
phi_pi = 1.5;
phi_y = 0.5;
...
//(4)Real exchange rate P156 in  textbook;
q = (1-alpha)*s;	
...
R = rnat +phi_pi*pi_h + phi_y*ygap + v; //nolonger optimal due to shock presence
//R =  phi_pi*pi; //Domestic inflation Taylor rule (DIT)
