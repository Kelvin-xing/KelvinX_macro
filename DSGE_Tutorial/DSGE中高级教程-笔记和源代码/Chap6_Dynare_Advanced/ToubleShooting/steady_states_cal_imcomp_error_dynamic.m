function [residual, g1, g2, g3] = steady_states_cal_imcomp_error_dynamic(y, x, params, steady_state, it_)
%
...
residual(5)= lhs-rhs;
lhs =exp(y(9));
rhs =1/params(2)*exp(params(6)*y(6))+x(it_, 2);
residual(6)= lhs-rhs;
lhs =exp(y(4));
rhs =exp(y(11));
residual(7)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(5,9)=(-exp(y(9)-y(14)));
  g1(5,10)=exp(y(10));
  g1(6,6)=(-(1/params(2)*params(6)*exp(params(6)*y(6))));
  g1(6,9)=exp(y(9));
  g1(6,16)=(-1);
  g1(7,4)=exp(y(4));
  g1(7,11)=(-exp(y(11)));
