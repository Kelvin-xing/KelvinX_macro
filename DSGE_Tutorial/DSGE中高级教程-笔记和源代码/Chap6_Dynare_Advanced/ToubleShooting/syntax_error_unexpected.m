...
options_ = [];
M_.fname = 'syntax_error_unexpected';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('syntax_error_unexpected.log');
M_.exo_names = 'eps_A';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('syntax_error_unexpected_static');
erase_compiled_function('syntax_error_unexpected_dynamic');
...
save('syntax_error_unexpected_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('syntax_error_unexpected_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('syntax_error_unexpected_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('syntax_error_unexpected_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('syntax_error_unexpected_results.mat', 'estimation_info', '-append');
end
