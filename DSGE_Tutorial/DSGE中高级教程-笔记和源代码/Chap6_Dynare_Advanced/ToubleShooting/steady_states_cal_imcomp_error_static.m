function [residual, g1, g2] = steady_states_cal_imcomp_error_static(y, x, params)
%
...
residual(5)= lhs-rhs;
lhs =exp(y(6));
rhs =1/params(2)*exp(y(3)*params(6))+x(2);
residual(6)= lhs-rhs;
lhs =exp(y(1));
rhs =exp(y(8));
residual(7)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(5,6)=(-exp(y(6)-y(3)));
  g1(5,7)=exp(y(7));
  g1(6,3)=(-(1/params(2)*params(6)*exp(y(3)*params(6))));
  g1(6,6)=exp(y(6));
  g1(7,1)=exp(y(1));
  g1(7,8)=(-exp(y(8)));
  g1(8,4)=1-params(3);
