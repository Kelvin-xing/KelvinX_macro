...
varexo  epsilon_tauk epsilon_tauw epsilon_tauc epsilon_tauy epsilon_lambdad epsilon_lambdamc epsilon_lambdami epsilon_lambdax epsilon_muz epsilon_epsilon
        epsilon_Upsilon epsilon_ztildestar epsilon_zetac epsilon_zetah epsilon_phitilde epsilon_R epsilon_pibar epsilon_pistar epsilon_ystar epsilon_Rstar 
...
//stoch_simul(irf=20) pi_hat w_barhat c_hat i_hat x R_hat E y_hat pi_mc pi_mi pi_c ;
