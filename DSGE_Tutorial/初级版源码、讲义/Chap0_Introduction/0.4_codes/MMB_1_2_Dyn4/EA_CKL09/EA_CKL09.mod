...
// Estimated for the euro area in Christoffel, Kuester, Linzert (EER, 2009)
//**************************************************************************
...
//
// This is the version of the model estimated in Section 5 of the paper.
//
...
vphi    = 1.63;      // inverse of Frisch elasticity
sig     = 1.44;      // CRRA
habit   = 0.22;      // habit persistence

omega       = 0.69;  // Calvo price stickiness
price_index = 0.17;  // degree of price indexation

xi          = 0.68;  // weight on unemployment in matching function
eta         = 0.5;   // bargaining power of workers
gamma       = 0.68;  // Calvo wage stickiness  
wage_index  = 0.44;  // wage indexation
vtheta      = 0.03;  // rate of separation
alp         = 0.66;  // labor elasticity of production

rho_eb      = 0.79;     // persistence of preference shock
rho_g       = 0.73;     // persistence of gov spending shock
rho_z       = 0.60;     // persistence of productivity shock 
rho_ebargain = 0.09;    // persistence of bargaining power shock

rho_ekappa   = 0.78;    // persistence of vacancy posting costs shock 
rho_esep     = 0.51;    // persistence of separation rate shock
rho_eC       = 0;       // persistence of cost-push shock
rho_emoney   = 0;        // persistence of mon pol shock


sig_innoeb          = 0.26; // varphi = 1: 0.218; varphi=2: 0.191; varphi=10: 0.18
sig_innoeC          = 1.94; // std dev of cost-push shock  
sig_innog           = 0.48; // std dev of inno to g shock (calculated below (depends on sample))
sig_monpol          = 0.12; // std dev of monpol shock  (calculated below from Taylor rule)
sig_innoz           = 0.39; // std dev of tech shock (calculated below (depends on alpha))
sig_innoebargain    = 43.48;// std deviation of bargaining power shock  
sig_innoekappa      = 7.62; // std deviation of vacancy posting shock  
sig_innoesep        = 3.47; // std deviation of separation shock  
...
gtildebar = 0.202648;             // share of government spending in GDP in data;
