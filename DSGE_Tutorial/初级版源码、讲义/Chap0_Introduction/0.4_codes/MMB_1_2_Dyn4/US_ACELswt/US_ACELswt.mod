...
// This version produces the right impulse responses to neutral and investment 
// specific technology shocks for the ACEL model without cost channel (nu = 0).
...
interest   = 4*R_t;                                                      //*
inflation  = pi_t + pi_t(-1) + pi_t(-2) + pi_t(-3);                      //*
inflationq = pi_t*4;                                                     //*
