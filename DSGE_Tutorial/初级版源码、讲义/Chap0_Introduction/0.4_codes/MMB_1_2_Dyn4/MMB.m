...
%
% 3) Add few lines of code in this file (\DynareModelBase\DynareModelBase.m) as follows:
%           - Only add code in this first cell
%           - Add the full name of the model (for ex. Woodford, Rotemberg (1997) ) 
%             to the lines right below this text. 
...
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
disp('1.  Small Calibrated Models');
disp('    1.1. NK_RW97: Rotemberg, Woodford (1997)');
disp('    1.2. NK_LWW03: Levin, Wieland, Williams (2003)');
disp('    1.3. NK_CGG99: Clarida, Gali, Gertler (1999) Hybrid');
disp('    1.4. NK_CGG02: Clarida, Gali, Gertler (2002) 2-Country');
disp('    1.5. NK_MCN99cr: McCallum, Nelson (1999) (cr: Calvo-Rotemberg model)');
disp('    1.6. NK_IR04: Ireland (2004)');
disp('    1.7. NK_BGG99: Bernanke, Gertler, Gilchrist (1999)');
disp('    1.8. NK_GM05: Galí, Monacelli (2005)');
disp('    1.9. NK_GK09: Gertler, Karadi (2009)');
disp('    1.10. NK_CK08: Christoffel, Kuester (2008)');
disp('    1.11. NK_CKL09: Christoffel, Kuester, Linzert (2009)');
disp('    1.12. NK_RW06: Ravenna, Walsh (2006)');
disp('');
disp('2. Estimated US Models');
disp('    2.1. US_FM95: Fuhrer, Moore (1995)');
disp('    2.2. US_OW98: Orphanides, Wieland (1998) equivalent to MSR model in Levin et al. (2003)');
disp('    2.3. US_FRB03: FRB-US model linearized by Levin, Wieland, Williams (2003)');
disp('    2.4. US_FRB08: FRB-US model 08 linearized by Laubach (2008)');
disp('    2.5. US_FRB08mx: FRB-US model 08 mixed expectations, linearized by Laubach (2008)');
disp('    2.6. US_SW07: Smets, Wouters (2007)');
disp('    2.7. US_ACEL: CEE/ACEL model by Altig, Christiano, Eichenbaum & Linde (2005)');
disp('         (m = monetary policy shock, t = technology shock, sw = SW assumptions,');
disp('         (i.e. no cost channel & no timing constraints');
disp('    2.8. US_NFED08: New Fed US Model based on Edge, Kiley, Laforte (2007), version used for estimation in Wieland, Wolters (2010)');
disp('    2.9. US_RS99: Rudebusch, Svensson (1999)');
disp('    2.10. US_OR03: Orphanides (2003)');
disp('    2.11. US_PM08: IMF projection model US, Carabenciov et al. (2008)');
disp('    2.12. US_PM08fl: IMF projection model US (financial linkages), Carabenciov et al. (2008)');
disp('    2.13. US_DG08: De Graeve (2008)');
disp('    2.14. US_CD08: Christensen, Dib (2008)');
disp('    2.15. US_IAC05: Iacoviello (2005)');
disp('    2.16. US_MR07: Mankiw, Reis (2007)');
disp('    2.17. US_RA07: Rabanal (2007)');
disp('    2.18. US_CCTW10: Smets, Wouters (2007) model with rule-of-thumb consumers, estimated by Cogan et al. (2010)');
disp('    2.19. US_IR11: Ireland (2011)');
disp('');
disp('3. Estimated Euro Area Models');
disp('    3.1. EA_CW05ta: Coenen, Wieland (2005) (ta: Taylor-staggered contracts)');
disp('    3.2. EA_CW05fm: Coenen, Wieland (2005) (fm: Fuhrer-Moore contracts)');
disp('    3.3. EA_AWM05:  Area Wide model linearized by Kuester, Wieland (2005)');
disp('    3.4. EA_SW03: Smets and Wouters (2003)');
disp('    3.5. EA_SR07: Euro Area Model of Sveriges Riksbank, Adolfson et al. (2007)');
disp('    3.6. EA_QUEST3: QUEST III Euro Area Model of the DG-ECFIN EU, Ratto et al. (2009)');
disp('    3.7. EA_CKL09: Christoffel, Kuester, Linzert (2009)');
disp('    3.8. EA_GE10: Gelain (2010)');
disp('');
disp('4.  Estimated/calibrated Multi-Country Models');
disp('    4.1. G7_TAY93: Taylor (1993) G7 countries');
disp('    4.2. G3_CW03: Coenen, Wieland (2002, 2003) G3 countries');
disp('    4.3. EACZ_GEM03: IMF model of Euro Area and CZrep, Laxton, Pesenti (2003)');
disp('    4.4. G2_SIGMA08: FRB-SIGMA by Erceg, Guerrieri, Gust (2008)');
disp('    4.5. EAUS_NAWM08: Coenen, McAdam, Straub (2008) New Area Wide model of Euro Area and USA');
disp('    4.6. EAES_RA09: Rabanal (2009)');
disp('');
disp('5.  Estimated Models of other Countries');
disp('    5.1. CL_MS07: Medina, Soto (2007) model of the Chilean economy');
disp('    5.2. CA_ToTEM10: ToTEM model of Canada, based on Murchison, Rennison (2006), 2010 vintage');
disp('    5.3. BRA_SAMBA08: Gouvea et al. (2008), model of the Brazilian economy');
disp('    5.4. CA_LS07: Lubik and Schorfheide (20087), small-scale open-economy model of the Canadian economy');
disp('    5.5. HK_FPP11: Funke, Paetz and Pytlarczyk (2011), open-economy model of the Hong Kong economy');
...
modelbase.rule = menu('Choose a Policy Rule', 'Taylor (1993)', 'Gerdesmeier and Roffia (2003)', 'Levin, Wieland, Williams (2003)', 'Smets and Wouters US (2007)', 'Christiano, Eichenbaum, Evans (2005)'); 
