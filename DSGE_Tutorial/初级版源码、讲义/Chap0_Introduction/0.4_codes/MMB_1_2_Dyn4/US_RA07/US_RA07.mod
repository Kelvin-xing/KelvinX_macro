...
//************************************************************************** 
gammab gammaf kappap omegap beta thetap alpha gamma phi thetaw vaphi phi omegaw kappaw sigma b eta delta rhor gammap
...
//monetary policy
//r= rhor*r(-1)+(1-rhor)*gammap*pi+(1-rhor)*gammay*outputgap+epsz;
