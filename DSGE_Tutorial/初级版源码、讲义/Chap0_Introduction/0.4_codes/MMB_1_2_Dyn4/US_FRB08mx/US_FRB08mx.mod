...
zeco    =   mco *( zfecoa1*(qec-qec(-1))+ zfecoa2*(qec(+1)-qec) + zfecoa6*zeco(+1)+ zfecoa7*lzeco(+1) ) + (1 - mco) *( zbeco1 * picnil1 + zbeco2 * picnil2 + zbeco3 * picnil3 + zbeco4 * picnil3(-1)+ zbeco5 * rffel1+ zbeco6 * rffel2+ zbeco7 * rffel3 + zbeco8 * rffel3(-1) + zbeco9 * xgap2l1+ zbeco10 * xgap2l2 + zbeco11 * xgap2l3   + zbeco12 * xgap2l3(-1) + zbeco13 * ptr(-1) + zbeco14 * rtr(-1)+ zbeco15 * yhgpl1 + zbeco16 * yhgpl2 + zbeco17 * yhgpl3 + zbeco18 * yhgpl3(-1) + zbeco19 * yhtgpl1+ zbeco20 * yhtgpl2 + zbeco21 * yhtgpl3 + zbeco22 * yhtgpl3(-1)+ zbeco23 * yhpgpl1 + zbeco24 * yhpgpl2 + zbeco25 * yhpgpl3 + zbeco26 * yhpgpl3(-1)+ zbeco27 * hggdpt(-1)/400 + zbeco28 * (qecl1 - qecl2) + zbeco29 * (qecl2 - qecl3) + zbeco30 * (qecl3 - qecl4)+ zbeco31 * (qecl4 - qecl4(-1))  );
zecd    =   mco *( zfecda1*(qecd-qecd(-1))+ zfecda2*(qecd(+1)-qecd)+ zfecda6*zecd(+1)+ zfecda7*lzecd(+1))    + (1 - mco) *( zbecda1 * picnil1+ zbecda2  * picnil2 + zbecda3  * picnil3 + zbecda4  * picnil3(-1)+ zbecda5  * rffel1+ zbecda6  * rffel2+ zbecda7  * rffel3 + zbecda8  * rffel3(-1) + zbecda9  * xgap2l1 + zbecda10 * xgap2l2+ zbecda11 * xgap2l3 + zbecda12 * xgap2l3(-1)+ zbecda13 * ptr(-1)+ zbecda14 * rtr(-1)+ zbecda15 * yhgpl1+ zbecda16 * yhgpl2+ zbecda17 * yhgpl3+ zbecda18 * yhgpl3(-1) + zbecda19 * yhtgpl1 + zbecda20 * yhtgpl2+ zbecda21 * yhtgpl3  + zbecda22 * yhtgpl3(-1) + zbecda23 * yhpgpl1+ zbecda24 * yhpgpl2+ zbecda25 * yhpgpl3+ zbecda26 * yhpgpl3(-1)+ zbecda27 * hggdpt(-1)/400 + zbecda28 * (qecdl1-qecdl2)+zbecda29 * (qecdl2-qecdl3)+ zbecda30 * (qecdl3-qecdl4) + zbecda31 * (qecdl4-qecdl4(-1))  );
zgapc2  =   mco * ( zfgapc2a1*xgap2 + zfgapc2a6*zgapc2(+1) + zfgapc2a7*lzgapc2(+1) ) + (1 - mco) * ( zbgapc2a1 * picnil1+ zbgapc2a2 * picnil2 + zbgapc2a3 * picnil3  + zbgapc2a4 * picnil3(-1) + zbgapc2a5 * rffel1+ zbgapc2a6 * rffel2 + zbgapc2a7 * rffel3  + zbgapc2a8 * rffel3(-1) + zbgapc2a9 * xgap2l1 + zbgapc2a10 * xgap2l2 + zbgapc2a11 * xgap2l3 + zbgapc2a12 * xgap2l3(-1)+ zbgapc2a13 * ptr(-1) + zbgapc2a14 * rtr(-1)  );
zeh     =   mco * ( zfeha1*(qeh-qeh(-1))+ zfeha2*(qeh(+1)-qeh)+ zfeha3*(qehf1(+1)-qeh(+1))+ zfeha6*zeh(+1)+ zfeha7*lzeh(+1) + zfeha8*zehf2(+1) )+ (1 - mco) *( zbeha1 * picnil1 + zbeha2  * picnil2 + zbeha3  * picnil3 + zbeha4  * picnil3(-1)+ zbeha5  * rffel1 + zbeha6  * rffel2 + zbeha7  * rffel3 + zbeha8  * rffel3(-1) + zbeha9  * xgap2l1+ zbeha10 * xgap2l2+ zbeha11 * xgap2l3+ zbeha12 * xgap2l3(-1)+ zbeha13 * ptr(-1)+ zbeha14 * rtr(-1)+ zbeha15 * yhgpl1+ zbeha16 * yhgpl2+ zbeha17 * yhgpl3+ zbeha18 * yhgpl3(-1)+ zbeha19 * yhtgpl1 +zbeha20 * yhtgpl2 + zbeha21 * yhtgpl3+ zbeha22 * yhtgpl3(-1)+ zbeha23 * yhpgpl1 + zbeha24 * yhpgpl2+ zbeha25 * yhpgpl3 + zbeha26 * yhpgpl3(-1)+ zbeha27  * hggdpt(-1)/400+ zbeha28  * (qehl1-qehl2) + zbeha29  * (qehl2-qehl3)+ zbeha30  * (qehl3-qehl4)+ zbeha31  * (qehl4-qehl4(-1)) );
zvpdc   =   mco * ( zfvpdc1*(vpdc-vpdc(-1))+ zfvpdc2*(vpdc(+1)-vpdc)+ zfvpdc3*(vpdcf1(+1)-vpdc(+1))+ zfvpdc6*zvpdc(+1)+ zfvpdc7*lzvpdc(+1) + zfvpdc8*zvpdcf2(+1) )+ (1 - mco) * ( zbvpdca1 * picnil1 + zbvpdca2 * picnil2 + zbvpdca3 * picnil3 + zbvpdca4 * picnil3(-1)+ zbvpdca5 * rffel1 + zbvpdca6 * rffel2 + zbvpdca7 * rffel3 + zbvpdca8 * rffel3(-1) + zbvpdca9 * rtr(-1) + zbvpdca10 * ptr(-1)+zbvpdca11 * xgapl1 + zbvpdca12 * xgapl2+ zbvpdca13 * xgapl3 + zbvpdca14 * xgapl3(-1)+ zbvpdca15 * (xbl1-xbl2)+ zbvpdca16 * (xbl2-xbl3)+ zbvpdca17 * (xbl3-xbl4) + zbvpdca18 * (xbl4-xbl4(-1))+ zbvpdca19 * (vpdcl1-vpdcl2) + zbvpdca20 * (vpdcl2-vpdcl3)+ zbvpdca21 * (vpdcl3-vpdcl4) + zbvpdca22 * (vpdcl4-vpdcl4(-1))  );
zvpdo   =   mco * ( zfvpdo1*(vpdo-vpdo(-1))+ zfvpdo2*(vpdo(+1)-vpdo)+ zfvpdo3*(vpdof1(+1)-vpdo(+1))+ zfvpdo6*zvpdo(+1)+ zfvpdo7*lzvpdo(+1)+ zfvpdo8*zvpdof2(+1) )+ (1 - mco) * ( zbvpdoa1 * picnil1  + zbvpdoa2 * picnil2 + zbvpdoa3 * picnil3 + zbvpdoa4 * picnil3(-1)+ zbvpdoa5 * rffel1 + zbvpdoa6 * rffel2 + zbvpdoa7 * rffel3 + zbvpdoa8 * rffel3(-1) + zbvpdoa9 * rtr(-1) + zbvpdoa10 * ptr(-1)+ zbvpdoa11 * xgapl1+ zbvpdoa12 * xgapl2+ zbvpdoa13 * xgapl3 + zbvpdoa14 * xgapl3(-1)+ zbvpdoa15 * (xbl1-xbl2)+ zbvpdoa16 * (xbl2-xbl3)+ zbvpdoa17 * (xbl3-xbl4) + zbvpdoa18 * (xbl4-xbl4(-1))+ zbvpdoa19 * (vpdol1-vpdol2) + zbvpdoa20 * (vpdol2-vpdol3)+ zbvpdoa21 * (vpdol3-vpdol4) + zbvpdoa22 * (vpdol4-vpdol4(-1))  );
zvps    =   mco * ( zfvps1*(vps-vps(-1))+ zfvps2*(vps(+1)-vps)+ zfvps3*(vpsf1(+1)-vps(+1))+ zfvps6*zvps(+1)+ zfvps7*lzvps(+1) + zfvps8*zvpsf2(+1) ) + (1 - mco) *( zbvpsa1 * picnil1+ zbvpsa2 * picnil2 + zbvpsa3 * picnil3+ zbvpsa4 * picnil3(-1) + zbvpsa5 * rffel1 + zbvpsa6 * rffel2+ zbvpsa7 * rffel3 + zbvpsa8 * rffel3(-1) + zbvpsa9 * rtr(-1) + zbvpsa10 * ptr(-1)+ zbvpsa11 * xgapl1 + zbvpsa12 * xgapl2+ zbvpsa13 * xgapl3 + zbvpsa14 * xgapl3(-1)+ zbvpsa15 * (xbl1-xbl2) + zbvpsa16 * (xbl2-xbl3)+ zbvpsa17 * (xbl3-xbl4)+ zbvpsa18 * (xbl4-xbl4(-1))+ zbvpsa19 * (vpsl1-vpsl2)+ zbvpsa20 * (vpsl2-vpsl3) + zbvpsa21 * (vpsl3-vpsl4)+ zbvpsa22 * (vpsl4-vpsl4(-1)) );
zxbc    =   mco * ( zfxbc1*(xb-xb(-1))+ zfxbc2*(xb(+1)-xb)+ zfxbc3*(xbf1(+1)-xb(+1)) + zfxbc6*zxbc(+1)+ zfxbc7*lzxbc(+1)+ zfxbc8*zxbcf2(+1)) + (1 - mco) *( zbxbca1 * picnil1 + zbxbca2 * picnil2 + zbxbca3 * picnil3 + zbxbca4 * picnil3(-1)+ zbxbca5 * rffel1 + zbxbca6 * rffel2 + zbxbca7 * rffel3 + zbxbca8 * rffel3(-1) + zbxbca9 * rtr(-1)+ zbxbca10 * ptr(-1) + zbxbca11 * xgapl1+ zbxbca12 * xgapl2 + zbxbca13 * xgapl3 + zbxbca14 * xgapl3(-1)+ zbxbca15 * (xbl1-xbl2)+ zbxbca16 * (xbl2-xbl3)+ zbxbca17 * (xbl3-xbl4)+ zbxbca18 * (xbl4-xbl4(-1))+ zbxbca19 * (vpdcl1-vpdcl2)+ zbxbca20 * (vpdcl2-vpdcl3) + zbxbca21 * (vpdcl3-vpdcl4)+ zbxbca22 * (vpdcl4-vpdcl4(-1)) + zbxbca23 * hgx/400   );
zxbo    =   mco * ( zfxbo1*(xb-xb(-1))+ zfxbo2*(xb(+1)-xb)+ zfxbo3*(xbf1(+1)-xb(+1))+ zfxbo6*zxbo(+1)+ zfxbo7*lzxbo(+1)+ zfxbo8*zxbof2(+1) ) + (1 - mco) *( zbxboa1 * picnil1 + zbxboa2 * picnil2 + zbxboa3 * picnil3 + zbxboa4 *picnil3(-1) + zbxboa5 * rffel1 + zbxboa6 * rffel2 + zbxboa7 * rffel3+ zbxboa8 * rffel3(-1) + zbxboa9 * rtr(-1) + zbxboa10 * ptr(-1) + zbxboa11 * xgapl1+ zbxboa12 * xgapl2 + zbxboa13 * xgapl3+ zbxboa14 * xgapl3(-1) + zbxboa15 * (xbl1-xbl2) + zbxboa16 * (xbl2-xbl3)+ zbxboa17 * (xbl3-xbl4)+ zbxboa18 * (xbl4-xbl4(-1))+ zbxboa19 * hgx/400  );
zxbs    =   mco * ( zfxbs1*(xb-xb(-1))+ zfxbs2*(xb(+1)-xb)+ zfxbs3*(xbf1(+1)-xb(+1))+ zfxbs6*zxbs(+1)+ zfxbs7*lzxbs(+1)+ zfxbs8*zxbsf2(+1) ) + (1 - mco) *( zbxbsa1 * picnil1 + zbxbsa2 * picnil2+ zbxbsa3 * picnil3 + zbxbsa4 * picnil3(-1) + zbxbsa5 * rffel1+ zbxbsa6 * rffel2  + zbxbsa7 * rffel3 + zbxbsa8 * rffel3(-1)+ zbxbsa9 * rtr(-1) + zbxbsa10 * ptr(-1) + zbxbsa11 * xgapl1+ zbxbsa12 * xgapl2 + zbxbsa13 * xgapl3+ zbxbsa14 * xgapl3(-1)+ zbxbsa15 * (xbl1-xbl2)+ zbxbsa16 * (xbl2-xbl3)+ zbxbsa17 * (xbl3-xbl4)+ zbxbsa18 * (xbl4-xbl4(-1)) + zbxbsa19 * hgx/400  );
zpib5   =   mco * ( zfpib5a1*400*(pxbr - pxbr(-1) + dlpxp)+ zfpib5a6*zpib5(+1)) + (1- mco) *( zbpib5a1 * picnil1 + zbpib5a2 * picnil2 + zbpib5a3 * picnil3+ zbpib5a4 * picnil3(-1) + zbpib5a5 * rffel1 + zbpib5a6 * rffel2  + zbpib5a7 * rffel3 + zbpib5a8 * rffel3(-1) + zbpib5a9 *rtr(-1)+ zbpib5a10 *ptr(-1)+ zbpib5a11 * xgapl1 + zbpib5a12 * xgapl2 + zbpib5a13 * xgapl3 + zbpib5a14 * xgapl3(-1) + zbpib5a15 * 400 * dpxbl1+ zbpib5a16 * 400 * dpxbl2+ zbpib5a17 * 400 * dpxbl3 + zbpib5a18 * 400 * dpxbl3(-1)  );
zpi5    =   mco * ( zfpi5a1*picnia + zfpi5a6*zpi5(+1) )+ (1 - mco) *( zbpi5a1 * picnil1 + zbpi5a2 * picnil2 + zbpi5a3 * picnil3 + zbpi5a4 * picnil3(-1)+ zbpi5a5 * rffel1 + zbpi5a6 * rffel2+ zbpi5a7 * rffel3 + zbpi5a8 * rffel3(-1) + zbpi5a9 * rtr(-1)+ zbpi5a10 * ptr(-1) + zbpi5a11 * xgapl1 + zbpi5a12 * xgapl2 + zbpi5a13 * xgapl3+ zbpi5a14 * xgapl3(-1)  );
zpi10   =   mco * ( zfpi10a1*picnia + zfpi10a6*zpi10(+1)  )+ (1 - mco) *( zbpi10a1 * picnil1+ zbpi10a2 * picnil2+ zbpi10a3 * picnil3+ zbpi10a4 * picnil3(-1)+ zbpi10a5 * rffel1 + zbpi10a6 * rffel2 + zbpi10a7 * rffel3+ zbpi10a8 * rffel3(-1)+ zbpi10a9 * rtr(-1)+ zbpi10a10 * ptr(-1)+ zbpi10a11 * xgapl1 + zbpi10a12 * xgapl2 + zbpi10a13 * xgapl3+ zbpi10a14 * xgapl3(-1)  );
zpic30  =   mca * ( zfpic30a1*picnia + zfpic30a6*zpic30(+1) ) + (1 - mca) * ( zbpic30a1 * picnia+ zbpic30a2 * picnil1 + zbpic30a3 * picnil2 + zbpic30a4 * picnil3 + zbpic30a5 * rffe + zbpic30a6 * rffel1 + zbpic30a7 * rffel2+ zbpic30a8 * rffel3 + zbpic30a9 * rtr + zbpic30a10 * ptr + zbpic30a11 * xgap + zbpic30a12 * xgapl1+ zbpic30a13 * xgapl2 + zbpic30a14 * xgapl3   );
zlhp    =   mco * ( zflhpa1*(qlhp-qlhp(-1))+ zflhpa2*(qlhp(+1)-qlhp)+ zflhpa6*zlhp(+1)+ zflhpa7*lzlhp(+1)  )+ (1 - mco) * ( zblhpa1 * picnil1 + zblhpa2 * picnil2 + zblhpa3 * picnil3 + zblhpa4 * picnil3(-1) + zblhpa5 * rffel1 + zblhpa6 * rffel2+ zblhpa7 * rffel3 + zblhpa8 * rffel3(-1) + zblhpa9 * rtr(-1) + zblhpa10 * ptr(-1) + zblhpa11 * xgapl1 + zblhpa12 * xgapl2 + zblhpa13 * xgapl3 + zblhpa14 * xgapl3(-1) + zblhpa15 * (xgl1 -xgl1(-1) - hlprdt(-1)/400) + zblhpa16 * (hgx(-1)/400 - hlprdt(-1)/400) );
zyh     =   mco * ( (1-(zfyha1^.25)*(zfyha2))*yh + (zfyha1^.25)*zyh(+1) ) + (1 - mco) *( zbyha1 * picnia + zbyha2 * picnil1+ zbyha3 * picnil2 + zbyha4 * picnil3 + zbyha5 * rffe  + zbyha6 * rffel1+ zbyha7 * rffel2+ zbyha8 * rffel3 + zbyha9 * xgap + zbyha10 * xgapl1  + zbyha11 * xgapl2 + zbyha12 * xgapl3 + zbyha13 * ptr+ zbyha14 * rtr + zbyha15 * yhgap+ zbyha16 * yhgpl1 + zbyha17 * yhgpl2 + zbyha18 * yhgpl3+ zyhst + xgdpt );
zyhp    =   mco * ( (1-(zfyhpa1^.25)*(zfyhpa2))*yhp + (zfyhpa1^.25)*zyhp(+1)  )+ (1 - mco) *( zbyhpa1 * picnia + zbyhpa2 * picnil1 + zbyhpa3 * picnil2+ zbyhpa4 * picnil3+ zbyhpa5 * rffe + zbyhpa6 * rffel1  + zbyhpa7 * rffel2+ zbyhpa8 * rffel3 + zbyhpa9 * xgap+ zbyhpa10 * xgapl1 + zbyhpa11 * xgapl2+ zbyhpa12 * xgapl3+ zbyhpa13 * ptr + zbyhpa14 * rtr  + zbyhpa15 * yhgap + zbyhpa16 * yhgpl1 + zbyhpa17 * yhgpl2+ zbyhpa18 * yhgpl3 + zbyhpa19 * yhpgap + zbyhpa20 * yhpgpl1 + zbyhpa21 * yhpgpl2 + zbyhpa22 * yhpgpl3+ zyhpst + zyhst + xgdpt  );
zyht    =   mco * ( (1-(zfyhta1^.25)*(zfyhta2))*yht + (zfyhta1^.25)*zyht(+1) ) + (1 - mco) * ( zbyhta1 * picnia+ zbyhta2 * picnil1 + zbyhta3 * picnil2+ zbyhta4 * picnil3+ zbyhta5 * rffe+ zbyhta6 * rffel1+ zbyhta7 * rffel2+ zbyhta8 * rffel3 + zbyhta9 * xgap + zbyhta10 * xgapl1 + zbyhta11 * xgapl2+ zbyhta12 * xgapl3+ zbyhta13 * ptr + zbyhta14 * rtr + zbyhta15 * yhgap + zbyhta16 * yhgpl1 + zbyhta17 * yhgpl2 + zbyhta18 * yhgpl3 + zbyhta19 * yhtgap+ zbyhta20 * yhtgpl1+ zbyhta21 * yhtgpl2  + zbyhta22 * yhtgpl3+ zyhtst + zyhst + xgdpt  );
zynid   =   mco * ( zfynida1*(qynidnr-qynidnr(-1)-(pxgr-pxgr(-1)))+zfynida2*(qynidnr(+1)-qynidnr-(pxgr(+1)-pxgr))+ zfynida6*zynid(+1)+ zfynida7*lzynid(+1)  ) + (1 - mco) * ( zbynida1 * picnil1 + zbynida2 * picnil2+ zbynida3 * picnil3+ zbynida4 * picnil3(-1) + zbynida5 * rffel1 + zbynida6 * rffel2+ zbynida7 * rffel3+ zbynida8 * rffel3(-1)+ zbynida9 * rtr(-1) + zbynida10 * ptr(-1)+ zbynida11 * xgapl1 + zbynida12 * xgapl2 + zbynida13 * xgapl3+ zbynida14 * xgapl3(-1) + zbynida15 * (qynidl1-qynidl2) + zbynida16 * (qynidl2-qynidl3) + zbynida17 * (qynidl3-qynidl4) + zbynida18 * (qynidl4-qynidl4(-1))+ zbynida19 * hggdpt(-1)/400  );
zlurc   =   mco * ( zflurca1*(lur-lurnat)+ zflurca6*zlurc(+1)  )+ (1 - mco) * ( zblurca1  * dlpll1 + zblurca2  * dlpll2 + zblurca3  * dlpll2(-1)  + zblurca4  * dlpxpl1 + zblurca5  * dlpxpl2 + zblurca6  * dlpxpl3 + zblurca7  * picnil1/400 + zblurca8  * picnil2/400 + zblurca9  * picnil3/400  + zblurca10 * picnil3(-1)/400 + zblurca11 * dpxncl1+ zblurca12 * dpxncl2+ zblurca13 * dpxncl2(-1) + zblurca14 * dpxgl1 + zblurca15 * dpxgl2 + zblurca16 * dpxgl3 + zblurca17 *dpxgl3(-1)+ zblurca18 *ptr(-1)/400 + zblurca19 * (pcniar(-1)-qpcniar(-1))+ zblurca20 * (pxncr(-1)-qpxncr(-1))+ zblurca21 * hprdtw(-1)+ zblurca22 * hlprdt(-1)/400 + zblurca23 * (lurl1 - lurnal1) + zblurca24 * (lurl2 - lurnal2) + zblurca25 * (lurl3 - lurnal3) + zblurca26 * (lurl3(-1) - lurnal3(-1))+ zblurca27 * rffel1/400+ zblurca28 * rffel2/400+ zblurca29 * rffel3/400 + zblurca30 * rffel3(-1)/400  + zblurca31 * rtr(-1)/400 + zblurca32 * (pcfrl1-pcfrl2) + zblurca33 * (pcerl1-pcerl1(-1))  );
zlurl   =   mco * ( zflurla1*(lur-lurnat)+ zflurla6*zlurl(+1) ) + (1 - mco) *( zblurla1  * dlpll1 + zblurla2  * dlpll2 + zblurla3  * dlpll2(-1)+ zblurla4  * dlpxpl1 + zblurla5  * dlpxpl2 + zblurla6  * dlpxpl3 + zblurla7  * picnil1/400  + zblurla8  * picnil2/400 + zblurla9  * picnil3/400  + zblurla10 * picnil3(-1)/400+ zblurla11 * dpxncl1+ zblurla12 * dpxncl2 + zblurla13 * dpxncl2(-1) + zblurla14 * dpxgl1+ zblurla15 * dpxgl2+ zblurla16 * dpxgl3 + zblurla17 * dpxgl3(-1) + zblurla18 * ptr(-1)/400+ zblurla19 * (pcniar(-1)-qpcniar(-1))+ zblurla20 * (pxncr(-1)-qpxncr(-1))+ zblurla21 * hprdtw(-1) + zblurla22 * hlprdt(-1)/400 + zblurla23 * (lurl1 - lurnal1)+ zblurla24 * (lurl2 - lurnal2)+ zblurla25 * (lurl3 - lurnal3) + zblurla26 * (lurl3(-1) - lurnal3(-1))+ zblurla27 * rffel1/400 + zblurla28 * rffel2/400 + zblurla29 * rffel3/400+ zblurla30 * rffel3(-1)/400 + zblurla31 * rtr(-1)/400+ zblurla32 * (pcfrl1-pcfrl2)+ zblurla33 * (pcerl1-pcerl1(-1))  );
zlurnc  =   mco * ( zflurnca1*(lur-lurnat)+ zflurnca6*zlurnc(+1)  )+ (1 - mco) * ( zblurnca1  * dlpll1+ zblurnca2  * dlpll2 + zblurnca3  * dlpll2(-1) + zblurnca4  * dlpxpl1 + zblurnca5  * dlpxpl2+ zblurnca6  * dlpxpl3 + zblurnca7  * picnil1/400+ zblurnca8  * picnil2/400 + zblurnca9  * picnil3/400 + zblurnca10 * picnil3(-1)/400 + zblurnca11 * dpxncl1+ zblurnca12 * dpxncl2 + zblurnca13 * dpxncl2(-1)+ zblurnca14 * dpxgl1 + zblurnca15 * dpxgl2 + zblurnca16 * dpxgl3+ zblurnca17 * dpxgl3(-1) + zblurnca18 * ptr(-1)/400 + zblurnca19 * (pcniar(-1)-qpcniar(-1))+ zblurnca20 * (pxncr(-1)-qpxncr(-1))+ zblurnca21 * hprdtw(-1)+ zblurnca22 * hlprdt(-1)/400 + zblurnca23 * (lurl1 - lurnal1)+ zblurnca24 * (lurl2 - lurnal2) + zblurnca25 * (lurl3 - lurnal3) + zblurnca26 * (lurl3(-1) - lurnal3(-1))+ zblurnca27 * rffel1/400+ zblurnca28 * rffel2/400 + zblurnca29 * rffel3/400 + zblurnca30 *rffel3(-1)/400 + zblurnca31 * rtr(-1)/400+ zblurnca32 * (pcfrl1-pcfrl2)+ zblurnca33 * (pcerl1-pcerl1(-1)));
zpc     =   mco * ( zfpca1*(qpcniar-qpcniar(-1)+dlpxp) + zfpca6*zpc(+1)  ) + (1 - mco) *( zbpca1  * dlpll1 + zbpca2  * dlpll2 + zbpca3  * dlpll2(-1)+ zbpca4  * dlpxpl1+ zbpca5  * dlpxpl2+ zbpca6  * dlpxpl3 + zbpca7  * picnil1/400 + zbpca8  * picnil2/400 + zbpca9  * picnil3/400+ zbpca10 * picnil3(-1)/400+ zbpca11 * dpxncl1 + zbpca12 * dpxncl2+ zbpca13 * dpxncl2(-1) + zbpca14 * dpxgl1+ zbpca15 * dpxgl2 + zbpca16 * dpxgl3 + zbpca17 * dpxgl3(-1) + zbpca18 * ptr(-1)/400 + zbpca19 * (pcniar(-1)-qpcniar(-1))+ zbpca20 * (pxncr(-1)-qpxncr(-1))+ zbpca21 * hprdtw(-1)+ zbpca22 * hlprdt(-1)/400 + zbpca23 * (lurl1 - lurnal1) + zbpca24 * (lurl2 - lurnal2)+ zbpca25 * (lurl3 - lurnal3) + zbpca26 * (lurl3(-1) - lurnal3(-1))+ zbpca27 * rffel1/400 + zbpca28 * rffel2/400 + zbpca29 * rffel3/400 + zbpca30 * rffel3(-1)/400 + zbpca31 * rtr(-1)/400+ zbpca32 * (pcfrl1-pcfrl2)+ zbpca33 * (pcerl1-pcerl1(-1)));
zpl     =   mco * ( zfpla1*(qplr-qplr(-1)+dlpxp)+ zfpla6*zpl(+1) )+ (1 - mco) * ( zbpla1  * dlpll1+ zbpla2  * dlpll2 + zbpla3  *dlpll2(-1)+ zbpla4  * dlpxpl1+ zbpla5  * dlpxpl2 + zbpla6  * dlpxpl3 + zbpla7  * picnil1/400  + zbpla8  * picnil2/400 + zbpla9  * picnil3/400 + zbpla10 * picnil3(-1)/400+ zbpla11 * dpxncl1 + zbpla12 * dpxncl2 + zbpla13 * dpxncl2(-1)  + zbpla14 * dpxgl1+ zbpla15 * dpxgl2 + zbpla16 * dpxgl3   + zbpla17 * dpxgl3(-1) + zbpla18 * ptr(-1)/400  + zbpla19 * (pcniar(-1)-qpcniar(-1))+ zbpla20 * (pxncr(-1)-qpxncr(-1))+ zbpla21 * hprdtw(-1) + zbpla22 * hlprdt(-1)/400+ zbpla23 * (lurl1 - lurnal1)+ zbpla24 * (lurl2 - lurnal2) + zbpla25 * (lurl3 - lurnal3)+ zbpla26 * (lurl3(-1) - lurnal3(-1))+ zbpla27 * rffel1/400 + zbpla28 * rffel2/400+ zbpla29 * rffel3/400 + zbpla30 * rffel3(-1)/400+ zbpla31 * rtr(-1)/400+ zbpla32 * (pcfrl1-pcfrl2) + zbpla33 * (pcerl1-pcerl1(-1)));
zpnc    =   mco * ( zfpnca1*(qpxncr-qpxncr(-1)+dlpxp)+ zfpnca6*zpnc(+1) ) + (1 - mco) *( zbpnca1  * dlpll1 + zbpnca2  * dlpll2 + zbpnca3  * dlpll2(-1)+ zbpnca4  * dlpxpl1+ zbpnca5  * dlpxpl2 + zbpnca6  * dlpxpl3+ zbpnca7  * picnil1/400+ zbpnca8  * picnil2/400 + zbpnca9  * picnil3/400 + zbpnca10 * picnil3(-1)/400+ zbpnca11 * dpxncl1 + zbpnca12 * dpxncl2 + zbpnca13 * dpxncl2(-1)+ zbpnca14 * dpxgl1 + zbpnca15 * dpxgl2+ zbpnca16 * dpxgl3+ zbpnca17 * dpxgl3(-1) + zbpnca18 * ptr(-1)/400 + zbpnca19 * (pcniar(-1)-qpcniar(-1))+ zbpnca20 * (pxncr(-1)-qpxncr(-1))+ zbpnca21 *hprdtw(-1)+ zbpnca22 * hlprdt(-1)/400+ zbpnca23 * (lurl1 - lurnal1) + zbpnca24 * (lurl2 - lurnal2) + zbpnca25 * (lurl3 - lurnal3) + zbpnca26 * (lurl3(-1) - lurnal3(-1)) + zbpnca27 * rffel1/400 + zbpnca28 * rffel2/400 + zbpnca29 * rffel3/400 + zbpnca30 * rffel3(-1)/400+ zbpnca31 * rtr(-1)/400+ zbpnca32 * (pcfrl1-pcfrl2) + zbpnca33 * (pcerl1-pcerl1(-1))  );
zdivgr  =   mca * ( zfdivgra1*400*(ynidnr - pxgr - (ynidnr(-1) -pxgr(-1))) + zfdivgra6*zdivgr(+1) ) + (1 - mca) *( zbdivgra1 * picnia + zbdivgra2 * picnil1 + zbdivgra3 * picnil2+ zbdivgra4 * picnil3 + zbdivgra5 * rffe + zbdivgra6 * rffel1+ zbdivgra7 * rffel2 + zbdivgra8 * rffel3 + zbdivgra9 * rtr+ zbdivgra10 * ptr  + zbdivgra11 * xgap  + zbdivgra12 * xgapl1 + zbdivgra13 * xgapl2+ zbdivgra14 * xgapl3+ zbdivgra15 * 400 * (ynidnr - ynidnl1 - dpxg)+ zbdivgra16 * 400 * (ynidnl1 - ynidnl2 - dpxgl1) + zbdivgra17 * 400 * (ynidnl2 - ynidnl3 - dpxgl2) + zbdivgra18 * 400 * (ynidnl3 - ynidnl3(-1) - dpxgl3) + zbdivgra19 * hggdpt  );
zrff5   =   mca * ( zfrff5a1*rffe + zfrff5a6*zrff5(+1) ) + (1 - mca) * ( zbrff5a1 * picnia+ zbrff5a2 * picnil1+ zbrff5a3 * picnil2 + zbrff5a4 * picnil3+ zbrff5a5 * rffe  + zbrff5a6 * rffel1 + zbrff5a7 * rffel2 + zbrff5a8 * rffel3 + zbrff5a9 * rtr + zbrff5a10 * ptr + zbrff5a11 * xgap + zbrff5a12 * xgapl1 + zbrff5a13 * xgapl2  + zbrff5a14 * xgapl3  );
zrff10  =   mca * ( zfrff10a1*rffe + zfrff10a6*zrff10(+1)) + (1 - mca) *( zbrff10a1 * picnia + zbrff10a2 * picnil1 + zbrff10a3 * picnil2 + zbrff10a4 * picnil3 + zbrff10a5 * rffe + zbrff10a6 * rffel1 + zbrff10a7 * rffel2 + zbrff10a8 * rffel3 + zbrff10a9 * rtr+ zbrff10a10 * ptr + zbrff10a11 * xgap + zbrff10a12 * xgapl1  + zbrff10a13 * xgapl2+ zbrff10a14 * xgapl3  );
zrff30  =   mca * ( zfrff30a1*rffe + zfrff30a6*zrff30(+1)) + (1 - mca) * ( zbrff30a1 * picnia + zbrff30a2 * picnil1 + zbrff30a3 * picnil2 + zbrff30a4 * picnil3 + zbrff30a5 * rffe+ zbrff30a6 * rffel1 + zbrff30a7 * rffel2+ zbrff30a8 * rffel3 + zbrff30a9 * rtr + zbrff30a10 * ptr + zbrff30a11 * xgap + zbrff30a12 * xgapl1  + zbrff30a13 * xgapl2+ zbrff30a14 * xgapl3  );
zgap05  =   mca * ( zfgap05a1*xgap + zfgap05a6*zgap05(+1)  )+ (1 - mca) *( zbgap05a1 * picnia + zbgap05a2 * picnil1+ zbgap05a3 * picnil2+ zbgap05a4 * picnil3+ zbgap05a5 * rffe + zbgap05a6 * rffel1+ zbgap05a7 * rffel2 + zbgap05a8 * rffel3+ zbgap05a9 * rtr + zbgap05a10 * ptr+ zbgap05a11 * xgap + zbgap05a12 * xgapl1 + zbgap05a13 * xgapl2+ zbgap05a14 * xgapl3  );
zgap10  =   mca * ( zfgap10a1*xgap + zfgap10a6*zgap10(+1)) + (1 - mca) *  ( zbgap10a1 * picnia + zbgap10a2 * picnil1 + zbgap10a3 * picnil2 + zbgap10a4 * picnil3 + zbgap10a5 * rffe+ zbgap10a6 * rffel1 + zbgap10a7 * rffel2 + zbgap10a8 * rffel3 + zbgap10a9 * rtr + zbgap10a10 * ptr  + zbgap10a11 * xgap + zbgap10a12 * xgapl1 + zbgap10a13 * xgapl2+ zbgap10a14 * xgapl3  );
zgap30  =   mca * ( zfgap30a1*xgap + zfgap30a6*zgap30(+1) ) + (1 - mca) * ( zbgap30a1 * picnia + zbgap30a2 * picnil1  + zbgap30a3 * picnil2+ zbgap30a4 * picnil3+ zbgap30a5 * rffe + zbgap30a6 * rffel1+ zbgap30a7 * rffel2 + zbgap30a8 * rffel3 + zbgap30a9 * rtr + zbgap30a10 * ptr  + zbgap30a11 * xgap+ zbgap30a12 * xgapl1 + zbgap30a13 * xgapl2 + zbgap30a14 * xgapl3 );
ptr     =   ptra1 * picxfl1 + ptra2 * picxfl2 + ptra3 * picxfl3 + ptra4 * picxfl3(-1) + ptra5 * rffel1 + ptra6 * rffel2 + ptra7 * rffel3  + ptra8 * rffel3(-1) + ptra9 * rtr(-1)+ ptra10 * ptr(-1) + ptra11 * xgapl1+ ptra12 * xgapl2+ ptra13 * xgapl3 + ptra14 * xgapl3(-1);
rtr     =  rrtr + ptr;
rrtr    =  rrtra1 * rrtr(-1) + (1 - rrtra1) *  (rffe - (picxfe + picxfl1 + picxfl2 + picxfl3)/4);
dpxg    = pxgr - pxgr(-1) + dlpxp;
dpxb    = pxbr - pxbr(-1) + dlpxp;
zyhst   =  zyhst(-1) + zyhsta1*(yhshr - zyhst(-1));
yhshr   =  yhshrs1 * (yh - xgdp);
yhgap   =  100 * (yhshr - zyhst);
zyhpst  =  zyhpst(-1) + zyhpsta1*(yhpshr - zyhpst(-1));
yhpshr  =  yhpshrs1 * (yhp - yh);
yhpgap  =  100 * (yhpshr - zyhpst);
zyhtst  =  zyhtst(-1) + zyhtsta1*(yhtshr - zyhtst(-1));
yhtshr  =  yhtshrs1 * (yht - yh);
yhtgap  =  100 * (yhtshr - zyhtst);
hlprdt  =  hgx - 400*(leppot - leppot(-1));
hprdtw  =  hprdtwa1 * hprdtw(-1) + (1 - hprdtwa1) * hlprdt/400;
