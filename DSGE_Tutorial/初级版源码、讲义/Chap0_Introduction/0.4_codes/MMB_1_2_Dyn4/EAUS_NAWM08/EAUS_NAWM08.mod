...
var EAUS_RER EA_B EA_BF EA_BY EA_C EA_CI EA_CJ EA_CY EA_D EA_EPSILONM EA_FH EA_FI 
  ...
  US_YGAP US_YGROWTH US_YS US_YSHARE US_Z EA_EPSG
...
// Modelbase Parameters                                                  //*
      ...
      coffispol                                                          //*
//**************************************************************************
  EA_ALPHA EA_BETA EA_BFYTARGET EA_BYTARGET EA_CHIH EA_CHII EA_CHIJ EA_CHIX 
...
// parameters to be added compared to original code
  ...
  EA_UPSILONT EA_UPSILONTR EA_interest_EXOG
  US_UPSILONT US_UPSILONTR US_RER US_interest_EXOG;
