...
%NOTE: the author informed us that the IRFs documented in the paper have been
%generated by an older version of the code

%NOTE2: the IRFs generated here are those derived when using
%parametrization from the paper; the difference to the IRFs in the paper is
%of small quantitative but not qualitative character
