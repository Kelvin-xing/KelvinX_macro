...
// Replication of ACF. GR (2003) policy rule used, which reacts to annual inflation,
// comparable ACF also for annual inflation
...
stoch_simul (irf = 0, ar=17) inflation outputgap interest dr;