...
M_.param_names = char(M_.param_names, 'lambdas');
M_.param_names_tex = char(M_.param_names_tex, 'lambdas');
M_.exo_det_nbr = 0;
M_.exo_nbr = 2;
M_.endo_nbr = 15;
M_.param_nbr = 21;
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('CIA_dynamic');
...
M_.params( 6 ) = 1.02;
pistar = M_.params( 6 );
M_.params( 13 ) = 1/M_.params(2)-1+M_.params(4);
Rs = M_.params( 13 );
kn = (alpha/Rs)^(1/(1-alpha));
M_.params( 12 ) = (1-M_.params(3))*kn^M_.params(3);
ws = M_.params( 12 );
M_.params( 14 ) = M_.params(6)/M_.params(2);
is = M_.params( 14 );
M_.params( 11 ) = 0.3333333333333333;
ns = M_.params( 11 );
M_.params( 15 ) = kn*M_.params(11);
ks = M_.params( 15 );
M_.params( 17 ) = M_.params(4)*M_.params(15);
Is = M_.params( 17 );
M_.params( 16 ) = kn^M_.params(3)*M_.params(11);
ys = M_.params( 16 );
M_.params( 10 ) = M_.params(16)-M_.params(17);
cs = M_.params( 10 );
M_.params( 18 ) = M_.params(6)*M_.params(10);
ms = M_.params( 18 );
M_.params( 21 ) = M_.params(2)/M_.params(10)/M_.params(6);
lambdas = M_.params( 21 );
M_.params( 20 ) = 1/M_.params(10)-M_.params(21);
mus = M_.params( 20 );
M_.params( 19 ) = M_.params(14)/M_.params(6);
rs = M_.params( 19 );
M_.params( 1 ) = M_.params(21)*M_.params(12)*(1-M_.params(11));
theta = M_.params( 1 );
%
...
oo_.steady_state( 2 ) = log(M_.params(11));
oo_.steady_state( 3 ) = log(M_.params(12));
oo_.steady_state( 4 ) = log(M_.params(13));
oo_.steady_state( 5 ) = log(M_.params(14));
oo_.steady_state( 6 ) = log(M_.params(15));
oo_.steady_state( 7 ) = 0;
oo_.steady_state( 8 ) = log(M_.params(16));
oo_.steady_state( 9 ) = log(M_.params(17));
oo_.steady_state( 10 ) = 0;
oo_.steady_state( 11 ) = log(M_.params(6));
oo_.steady_state( 12 ) = log(M_.params(18));
oo_.steady_state( 13 ) = log(M_.params(19));
oo_.steady_state( 15 ) = log(M_.params(21));
oo_.steady_state( 14 ) = log(M_.params(20));
...
M_.Sigma_e(2, 2) = M_.params(7)^2;
M_.sigma_e_is_diagonal = 1;
options_.order = 1;
var_list_=[];
info = stoch_simul(var_list_);
save('CIA_results.mat', 'oo_', 'M_', 'options_');
diary off
