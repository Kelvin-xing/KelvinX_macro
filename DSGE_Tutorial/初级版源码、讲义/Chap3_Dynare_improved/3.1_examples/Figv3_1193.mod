%----------------------------------------------------------------
% Experiment  : Permenant increase in taun at t=10
%----------------------------------------------------------------


// This program replicates figure 11.9.3 from chapter 11 of RMT3 by Ljungqvist and Sargent
...
//Declares the endogenous variables consumption ('c') capital stock (k)labor ('n');
var c k n;
//declares the exogenous variables  consumption tax ('tauc'), labor tax('taun'),capital tax('tauk'), government spending('g')
...
subplot(2,3,6)
plot([0:9],ex_(1:10,4),'k','LineWidth',1.5);
hold on;
plot([10:N-1],ex_(11:N,4),'k','LineWidth',1.5);
hold on;
