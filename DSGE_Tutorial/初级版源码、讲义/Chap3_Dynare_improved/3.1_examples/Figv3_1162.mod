%---------------------------------------------------------------------
% Experiment  : Impact of gamma on transition (using gamma= 2 and .2)
%---------------------------------------------------------------------

// This program replicates figure 11.6.2 from chapter 11 of RMT3 by Ljungqvist and Sargent
...
// we use shocks to undo that for the first 10 periods and leave g at
