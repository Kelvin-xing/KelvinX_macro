...
options_ = [];
M_.fname = 'Growthestimate';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('Growthestimate.log');
M_.exo_names = 'e';
M_.exo_names_tex = 'e';
M_.exo_names_long = 'e';
M_.endo_names = 'c';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('Growthestimate_static');
erase_compiled_function('Growthestimate_dynamic');
...
estim_params_.var_exo = [estim_params_.var_exo; 1, NaN, (-Inf), Inf, 4, 0.95, 30, NaN, NaN, NaN ];
...
save('Growthestimate_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('Growthestimate_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('Growthestimate_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('Growthestimate_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('Growthestimate_results.mat', 'estimation_info', '-append');
end
