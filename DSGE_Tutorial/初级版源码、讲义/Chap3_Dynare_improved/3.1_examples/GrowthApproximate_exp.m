...
options_ = [];
M_.fname = 'GrowthApproximate_exp';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('GrowthApproximate_exp.log');
M_.exo_names = 'e';
M_.exo_names_tex = 'e';
M_.exo_names_long = 'e';
M_.endo_names = 'y';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('GrowthApproximate_exp_static');
erase_compiled_function('GrowthApproximate_exp_dynamic');
...
oo_.steady_state( 3 ) = 3.391762344688956;
oo_.steady_state( 2 ) = 1.4;
oo_.steady_state( 5 ) = 0.2999999999999999;
...
var_list_=[];
dynasave('simudata_exp.mat',var_list_);
save('GrowthApproximate_exp_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('GrowthApproximate_exp_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('GrowthApproximate_exp_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('GrowthApproximate_exp_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('GrowthApproximate_exp_results.mat', 'estimation_info', '-append');
end
