%----------------------------------------------------------------
% Experiment  : unforseen increase in taun at t=0
%----------------------------------------------------------------


// This program replicates figure 11.9.2 from chapter 11 of RMT3 by Ljungqvist and Sargent
...
var c k n;
//declares the exogenous variables //  consumption tax ('tauc'), capital tax('tauk'), labor tax('taun'),government spending('g')
...
subplot(2,3,6)
plot(x,[taun0*ones(N,1)],'--k', x,ex_(1:N,4),'k','LineWidth',1.5)
title('\tau_n','Fontsize',12)
axis([0 40 -.1 .5])
set(gca,'Fontsize',12)

print -depsc fig_tnu.eps
