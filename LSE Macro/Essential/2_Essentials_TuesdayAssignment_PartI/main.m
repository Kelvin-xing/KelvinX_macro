...
% the par.*** defines a "structure" called "par" which has all the
% elements. So by passing "par" to an external function you would pass the
% whole structure
...
%GRID AND YOU CAN PLOT FIGURE 2 BY UNCOMMENTING.
%p = ...; 
