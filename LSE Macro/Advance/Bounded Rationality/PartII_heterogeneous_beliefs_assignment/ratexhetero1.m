...
save parametervalues alpha rho_z rho_i sig_z sig_i eta wcoef betta
...
% set initial values ALM as perceived by rational agent XXX
...
if A_rational == 1
    ...
    %
    % XXX program here the values of these coefficients if these guys are
    % rational
    %
    ...
    % and here if they are not rational
...
save parametervalues alpha rho_z rho_z_A rho_i rho_i_A sig_z sig_i eta wcoef wcoef_A betta
...
%
%   note that n_new is a 4x1 vector with the two employment choices of the
%   rational firm and the two employment choices of the type-A firm
...
if A_rational == 1
    ...
    %
    % XXX program here the values of the perceived law of motion if these
    % guys are rational
    %

else
    
    % if they are not rational we just let them keep things equal to a
    % constant
