...
//
// XXX you have to write down the two Euler equations for type A firms
//
...
//
// XXX you have to write down the two equations for how the rational and the type_A firms 
// perceive the law of motion for N
//
% true wage rate
