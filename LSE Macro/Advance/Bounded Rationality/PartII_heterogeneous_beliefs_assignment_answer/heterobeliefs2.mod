...
parameters rho_z  , rho_i  , sig_z, sig_i, alpha, s_prob, 
           rho_z_A, rho_i_A, eta,
...
betta*alpha*n_1_R^(alpha-1)*z_i(+1)*z_1(+1) = betta*wage_exp_R + eta*(n_1_R    +n_2_R    - n_1_R(-1)-n_2_R(-1)) 
                                            - betta*(1-s_prob)*eta*(n_1_R(+1)+n_2_R(+1)- n_1_R    -n_2_R    )
                                            - betta*   s_prob *eta*(1                  - n_1_R    -n_2_R    );     
